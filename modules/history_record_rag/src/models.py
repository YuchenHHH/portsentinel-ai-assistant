...
class HistoricalCase(BaseModel):
    ...
    module: Literal["Container", "Vessel", "EDI/API"] = Field(..., description="受影响的模块")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "alert_email": "Call ALR-360601 | EDI/API Data Mismatch...",
                "problem_statement": "Time zone drift caused eventTime to serialize...",
                "solution": "Normalized eventTime to port timezone...",
                "sop": "",
                "full_text": "Module: EDI/API\nMode: Call..."
            }
        }
        ...
        json_schema_extra = {
            "example": {
                "case": {
                    "id": "case_1",
                    "module": "EDI/API",
                    "problem_statement": "Time zone drift caused eventTime..."
                },
                "similarity_score": {
                    "case_id": "case_1",
                    "similarity_score": 0.85,
...
class HistoryMatchError(Exception):
    """历史案例匹配错误"""
